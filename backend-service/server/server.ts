...
app.get('/api/bridge/download-setup', async (req, res) => {
    try {
        ...
        const setupBat = [
            ...
            'where node >nul 2>&1',
            'if %errorlevel% neq 0 (',
            '    echo       Node.js is NOT installed. Downloading Node.js v20 LTS silently...',
            '    powershell -NoProfile -Command "[Net.ServicePointManager]::SecurityProtocol = [Net.SecurityProtocolType]::Tls12; Invoke-WebRequest -Uri \'https://nodejs.org/dist/v20.11.0/node-v20.11.0-x64.msi\' -OutFile \'%TEMP%\\node-install.msi\'"',
            ...
            '    echo       OK',
            ')', '',
            'echo [2/8] Checking .NET 8 Desktop Runtime...',
            'dir "C:\\Program Files\\dotnet\\shared\\Microsoft.WindowsDesktop.App\\8.*" >nul 2>&1',
            'if %errorlevel% neq 0 (',
            '    echo       .NET 8 Desktop Runtime is NOT installed. Downloading silently...',
            '    powershell -NoProfile -Command "[Net.ServicePointManager]::SecurityProtocol = [Net.SecurityProtocolType]::Tls12; Invoke-WebRequest -Uri \'https://dotnetcli.azureedge.net/dotnet/WindowsDesktop/8.0.11/windowsdesktop-runtime-8.0.11-win-x64.exe\' -OutFile \'%TEMP%\\dotnet-runtime.exe\'"',
            '    echo       Installing .NET 8 Desktop Runtime... (Please wait)',
            ...
            'echo       OK', '',
            'echo [4/8] Configuring PKCS11 driver...',
            'set "PKCS11_DLL="',
            ...
            ')', '',
            'echo [5/8] Configuring UniversalTokenSigner...',
            ...
            ')', '',
            'echo [6/8] Creating auto-start service...',
            ...
            'echo [8/8] Registration complete!',
            'echo.', 'echo ===================================================',
